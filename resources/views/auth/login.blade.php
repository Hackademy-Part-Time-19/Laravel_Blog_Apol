...
<div style="display: flex;" id="RegistrazioneUtente" class="RegistrazioneUtente">
    <div class="RegistrazioneContainer">

        <div class="containerKeri" id="Kericontainer">

            <div class="form-container sign-up-container">
        <div style="display: flex; justify-content: end;align-items: start; position: absolute; right: 10px;top:-5px;background-color: rgba(255, 255, 255, 0);height: auto;">
<a  href="{{ route('HomePage') }}" >    <i style="background-color: white;" id="CloseLogin"  class="bi bi-x-circle"></i></a>
        </div>
        ...
        <form action="/register" method="POST">
            ...
            <div  class="overlay-container">
                ...
                margin: 0;background-color: black">Bentornato!</h1>
                        <p style="	font-size: 14px;
                        font-weight: 100;
                        line-height: 20px;
                        letter-spacing: 0.5px;
                        margin: 20px 0 30px;background-color: black">Effettua il login con i tuoi dati.</p>
                    ...
                    <div style="background-color: black" class="overlay-panel overlay-right">
                        ...
                        style="display: flex; justify-content: end;align-items: start; position: absolute; right: 10px;top:-5px;background-color: rgba(255, 255, 255, 0);height: auto;">
                            <a  href="{{ route('HomePage') }}"><i style="background-color: rgb(0, 0, 0)"  id="CloseLogin2" class="bi bi-x-circle"></i></a>
                        </div>
                        <h1 style="font-weight: bold;
                margin: 0;background-color: black">Ciao!</h1>
                        <p style="	font-size: 14px;
                    font-weight: 100;
                    line-height: 20px;
                    letter-spacing: 0.5px;
                margin: 20px 0 30px;background-color: black">Inserisci i tuoi dati e inizia il viaggio con noi.</p>
