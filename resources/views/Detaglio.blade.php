            ...
            <div class="row">
                <div id="card">
                    <div id="card" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div id="CardsBox">
                            <img style="object-fit: cover; object-position: center" src=" {{ Storage::url($articolo['image']) }}" width="100%" height="800px"
                                alt="">
                            <div id="CardsBox2">
                                <h2> {{ $articolo['title'] }}</h2>
                                <div style="display: flex; align-items:end;background-color: rgba(255, 255, 255, 0)">
                                    <h5>Categoria: <img
                                            style="background-color: rgba(255, 255, 255, 0);margin-bottom: 7px;margin-left: 3px"
